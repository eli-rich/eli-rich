...
**Hobbyist programmer | Systems & Backend | Cybersecurity Student | Professional "Hello, World!" Author**
...
- **[goc4](https://github.com/eli-rich/goc4)** - A complete Connect 4 engine written in Go
  - [Try to beat it](https://connect4.werichardson.com) (spoiler: you probably won't)
  - Or check out the [source code](https://github.com/eli-rich/c4app) for the deployment
...
- **Tools**: [Neovim](https://github.com/neovim/neovim) (but I cheat with [Zed](https://github.com/zed-industries/zed)) · Linux daily driver btw
